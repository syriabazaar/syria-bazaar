  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="syriaBazaarApp.city.home.createOrEditLabel"
          data-cy="CityCreateUpdateHeading"
          v-text="t$('syriaBazaarApp.city.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('syriaBazaarApp.city.name')" for="city-name"></label>
            <input
              type="text"
              class="form-control"
              name="name"
