  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="syriaBazaarApp.brand.home.createOrEditLabel"
          data-cy="BrandCreateUpdateHeading"
          v-text="t$('syriaBazaarApp.brand.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('syriaBazaarApp.brand.name')" for="brand-name"></label>
            <input
              type="text"
              class="form-control"
              name="name"
